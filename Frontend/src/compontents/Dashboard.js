...
export default function Dashboard() {
  ...
  const getData = async () => {
    ...
    const newRetainedList = NewDataFromDateInterval(data.Lalatoys.retainedList, date);
    const newOnHoldList = NewDataFromDateInterval(data.Lalatoys.onHoldList, date);
